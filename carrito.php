                ...
                <tr class="align-middle">
                    ...
                    if (isset($_SESSION['user_logged_in']) && $_SESSION['user_logged_in'] == true) {
                        ...
                        echo '
                            ...
                            <td class="tdDatos">
                            <p class="username">¡Hola, ' . $_SESSION["usuario"] . '! <a id="logoutLink" class="logout-link">Cerrar sesión</a></p>
                            </td>
                        ';
                    } else {
            ...
            <div class="row">
                ...
                <?php
                    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                        ...
                        $idUnico = isset($_POST['iddelJuego']) ? $_POST['iddelJuego'] : ''; // Asegúrate de asignar un valor predeterminado
                    ...
                    if (isset($_SESSION['carrito']) && count($_SESSION['carrito']) > 0) {
                        ...
                        // Definir $precio utilizando la información del primer elemento del carrito
                        ...
                        // Agregar el formulario para realizar la compra
                        ...
                        echo '  <input type="hidden" name="cantStock" value="' . (isset($item['cantidad']) ? $item['cantidad'] : '') . '">';
                        echo '  <input type="hidden" name="totalGeneral" value="' . $totalGeneral . '">';
                        echo '  <input type="submit" class="btn btn-primary" value="Realizar Compra">';
                        echo '</form>';
